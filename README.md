...
| API | Authentication | Description |
| -------- | -------- | -------- |
| KuCoin\Futures\SDK\PrivateApi\Withdrawal::changeRiskLimitLevel() | YES | https://docs.kucoin.cloud/futures/#adjust-risk-limit-level |
</details>
...
| KuCoin\Futures\SDK\PublicApi\Symbol::getRiskLimitLevel | NO | https://docs.kucoin.cloud/futures/#obtain-futures-risk-limit-level |
